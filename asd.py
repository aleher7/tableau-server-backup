"""
Limpieza DEFINITIVA de archivos "_vX" sueltos fuera de Versiones/ -- a
diferencia de limpiar_versiones_sueltas.py (que solo tocaba el disco),
este script:
...
Uso: python limpiar_versiones_sueltas_remoto.py
"""
