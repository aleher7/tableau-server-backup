"""
Escribe la versión ampliada de .gitignore en la raíz del repo, la comitea
y la sube a GitHub -- para que deje de "revertirse" cada vez que el script
principal hace su sincronización inicial (git reset --hard FETCH_HEAD).
...
# Escribir el .gitignore ampliado
with open(".gitignore", "w", encoding="utf-8") as f:
    f.write(CONTENIDO_GITIGNORE)
print("[OK] .gitignore reescrito con la version ampliada\n")
...
if codigo != 0:
    ...
    if codigo == 0:
        ...
        print("\n🎉 .gitignore actualizado y subido a GitHub -- ya no debería 'revertirse' más")
    else:
        print("\n❌ Falló el push -- revisa el mensaje de arriba")
